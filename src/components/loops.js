		...
		return (
			<div className="Loops">
				<h3 className="Loops-title">Loops</h3>
					...
					There are three parameters of the for loop, each seperated by semi-colons:</p>
				<h3 className="Loops-header">The for...loop</h3>
					<ol>
						<li>The first parameter (var = 0 in the example) specifies a variable and
						...
						loop.</li>
						<li>The third parameter (var++ in the example) is a statement that executes with 
